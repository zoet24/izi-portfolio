$(window).scroll(function() {
   ...
   if ((wS > (hTa + (hHa/2) - ((1.05*wH)/2))) && (wS < (hTa + (hHa/2) - ((0.95*wH)/2)))){
       ...
       $("main").removeClass("about-bg-img-1", "about.css");
       $("main").removeClass("about-bg-img-2", "about.css");
       $("main").removeClass("about-bg-img-3", "about.css");
       $("main").removeClass("about-bg-img-4", "about.css");
       $("main").removeClass("about-bg-img-5", "about.css");
       $("main").removeClass("about-bg-img-6", "about.css");
